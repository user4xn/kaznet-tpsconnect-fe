<template>
  ...
  <default-sidebar>
    <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
      ...
      <side-menu isTag="router-link" title="Verifikasi TPS" icon="lock-open" :route="{ to: 'default.admin-permissions' }"></side-menu>
      <side-menu title="Menu" :static-item="true"></side-menu>
      <side-menu title="Data Masyarakat" icon="citizen-group" toggle-id="citizen" :caret-icon="true" :route="{ popup: 'false', to: 'user' }" @onClick="toggle" :active="currentRoute.includes('user')">
      ...
      <li><hr class="hr-horizontal" /></li>
      <side-menu title="Lokasi" :static-item="true"></side-menu>
      <side-menu isTag="router-link" title="Kabupaten" icon="lock-open" :route="{ to: 'default.admin-permissions' }"></side-menu>
      <side-menu isTag="router-link" title="Kecamatan" icon="lock-open" :route="{ to: 'default.admin-permissions' }"></side-menu>
      <side-menu isTag="router-link" title="Kelurahan" icon="lock-open" :route="{ to: 'default.admin-permissions' }"></side-menu>
    </ul>
  </default-sidebar>
