                ...
                <b-collapse v-model="addCollapse" id="addManual">
                  ...
                  <b-form @submit="handleAddManual">
                    <b-row>
                      ...
                      <b-col md="12 mt-4">
                        <b-form-group>
                          <b-button type="submit" class="w-100" variant="primary" :disabled="!manualSelectedJaringan || !selectedKabupaten || !selectedKecamatan || isOnSubmit">
  ...
  export default {
    ...
    methods: {
      handleExport: debounce(async function () {
        ...
        var queryParam = '?';
        let filename = 'KoordinatorKecamatan';
        ...
        await axios.get(`${process.env.VUE_APP_BACKEND_API}/api/v1/kordinator/kecamatan/export${queryParam ?? ''}`, {
          headers: { 
            'Authorization': `Bearer ${localStorage.getItem('jwtToken')}`
          },
      ...
      handleDelete(index) {
        ...
        this.$swal({
          ...
          if (result.isConfirmed) {
            try {
              const response = await axios.delete(`${process.env.VUE_APP_BACKEND_API}/api/v1/kordinator/kecamatan/delete/${id}`, withHeader);
      ...
      async handleEdit() {
        ...
        try {
          ...
          const response = await axios.put(`${process.env.VUE_APP_BACKEND_API}/api/v1/kordinator/kecamatan/update/${this.editInputID}`, body, withHeader);
      ...
      cariData: debounce(async function (showAll, page) {      
        ...
        const response = await axios.get(`${process.env.VUE_APP_BACKEND_API}/api/v1/kordinator/kecamatan/list${queryParam ?? ''}`, withHeader);
